        ...
        <div class="w-full">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('apoteker.sales.print', $sale->id) }}" class="btn btn-outline-primary btn-sm me-2" target="_blank">
                             Cetak Struk
                        </a>
                        <a href="{{ route('apoteker.sales.history') }}" class="btn btn-outline-secondary btn-sm">
                           Kembali
                        </a>
                    </div>
                </div>
