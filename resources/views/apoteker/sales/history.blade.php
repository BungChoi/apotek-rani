...
<div class="flex-grow-1">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('apoteker.sales.history') }}" method="GET" id="search-form">
                <div class="row g-3">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        ...
                        <a href="{{ route('apoteker.sales.history') }}" class="btn btn-outline-secondary">
                            Reset
                        </a>
                    </div>
                </div>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item sale-detail-btn" href="{{ route('apoteker.sales.show', $sale->id) }}" data-sale-id="{{ $sale->id }}">
                                        <i class="bx bx-show-alt me-1"></i> Detail
                                    </a>
                                    <a class="dropdown-item" href="{{ route('apoteker.sales.print', $sale->id) }}">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        saleDetailBtns.forEach(btn => {
            btn.addEventListener('click', function(e) {
                ...
                fetch(`{{ url('apoteker/sales') }}/${saleId}/details`)
