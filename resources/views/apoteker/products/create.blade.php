...
<div class="flex-grow-1">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Manajemen Obat /</span> Tambah Obat Baru
    </h4>
        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">Formulir Tambah Obat</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('apoteker.products.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
