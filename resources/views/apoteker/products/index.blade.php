...
@section('content')
    <div>
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ route('apoteker.products.create') }}" class="btn btn-primary shadow-sm">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('apoteker.products.index') }}" class="row">
                ...
                @if (request()->hasAny(['search', 'category', 'status']))
                    <div class="mt-2">
                        <a href="{{ route('apoteker.products.index') }}" class="btn btn-secondary btn-sm">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group" role="group">
                                                <div class="d-flex gap-1 flex-wrap">
                                                    <a href="{{ route('apoteker.products.show', $product->id) }}"
                                                        class="btn btn-primary btn-sm d-flex align-items-center justify-content-center"
                                                        style="width: 32px; height: 32px;" title="Lihat Detail">
                                                        <i class="bx bx-show"></i>
                                                    </a>

                                                    <a href="{{ route('apoteker.products.edit', $product->id) }}"
                                                        class="btn btn-warning btn-sm d-flex align-items-center justify-content-center"
                                                        style="width: 32px; height: 32px;" title="Edit">
                                                        <i class="bx bx-edit"></i>
                                                    </a>

                                                    <form action="{{ route('apoteker.products.destroy', $product->id) }}"
                    ...
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">
                            @if (request()->hasAny(['search', 'category', 'status']))
                                ...
                                <br><a href="{{ route('apoteker.products.index') }}"
                                    class="btn btn-secondary btn-sm mt-2">
                                    <i class="fas fa-times"></i> Reset Filter
                                </a>
                            @else
                                Belum ada obat yang terdaftar dalam sistem.
                                <br><a href="{{ route('apoteker.products.create') }}"
    ...
    <div class="toast-container position-fixed top-0 end-0 p-3" style="z-index: 5000; top: 10px; right: 10px;"></div>
@endsection
        ...
        $(document).ready(function() {
            ...
            $('.dropdown-menu').on('click', function(e) {
                if (e.target.tagName === 'BUTTON') {
                    // Allow buttons (like delete) to work
                    return true;
                }
                e.stopPropagation();
            });
