...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return view('apoteker.products.index', compact('products', 'categories'));
        } catch (\Exception $e) {
            // Log the error
            ...
            return view('apoteker.products.index', [
                'products' => $products,
                'categories' => collect([])
    ...
    public function create()
    {
        try {
            ...
            return view('apoteker.products.create', compact('categories', 'suppliers'));
        } catch (\Exception $e) {
            // Log the error
            ...
            return view('apoteker.products.create', [
                'categories' => collect([]),
                'suppliers' => collect([])
            ])->with('error', 'Terjadi kesalahan saat memuat data. Silakan coba lagi.');
        }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('apoteker.products.index')
    ...
    public function edit($id)
    {
        try {
            ...
            return view('apoteker.products.edit', compact('product', 'categories', 'suppliers'));
        } catch (\Exception $e) {
            // Log the error
    ...
    public function search(Request $request)
    {
        try {
            ...
            return view('apoteker.products.search', compact('categories', 'products'));
        } catch (\Exception $e) {
            // Log the error
            ...
            return view('apoteker.products.search', [
                'categories' => collect([]),
                'products' => $products
