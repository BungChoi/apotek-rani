...
class SalesController extends Controller
{
    ...
    public function pos()
    {
        ...
        return view('admin.sales.pos', compact('categories', 'products'));
    }
    ...
    public function reports(Request $request)
    {
        ...
        return view('admin.reports.sales', compact('sales', 'total_revenue', 'total_items_sold', 'total_transactions', 'start_date', 'end_date'));
    }
}
